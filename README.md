...
- [Hagezi Multi Pro](https://github.com/hagezi/dns-blocklists?tab=readme-ov-file#pro): Big Broom - Dọn dẹp Internet và bảo vệ quyền riêng tư của bạn! Chặn quảng cáo, liên kết, theo dõi, số liệu, đo từ xa, lừa đảo, phần mềm độc hại, lừa đảo, giả mạo, tiền xu và các "rác" khác.
